...
async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const {
      data
    } = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(`${BASE_URL}/api/guilds/${guildId}/members`, {
      headers: {
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8277);
      ...
      processEnv([])
        ...
        const apiHandler = (0,next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__/* .getApiHandler */ .Y)({
          pageModule: __webpack_require__(3144),
          rewrites: combinedRewrites,
          i18n: undefined,
          page: "/api/discord/listMembers",
          basePath: "",
          pageIsDynamic: false,
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [748,669,947,774,428], function() { return __webpack_require__(5509); })
