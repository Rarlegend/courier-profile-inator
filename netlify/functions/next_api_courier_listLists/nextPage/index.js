...
/* harmony export */ });
/* harmony import */ var _trycourier_courier__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1016);
...
async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const client = (0,_trycourier_courier__WEBPACK_IMPORTED_MODULE_0__/* .CourierClient */ .i)({
      authorizationToken: authToken
    });
    const {
      items
    } = await client.lists.list().catch(ex => {
      console.log(ex);
      res.status(500).end();
    });
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8277);
      ...
      processEnv([])
        ...
        const apiHandler = (0,next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__/* .getApiHandler */ .Y)({
          pageModule: __webpack_require__(4575),
          rewrites: combinedRewrites,
          i18n: undefined,
          page: "/api/courier/listLists",
          basePath: "",
          pageIsDynamic: false,
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [748,669,947,774,16,428], function() { return __webpack_require__(4641); })
