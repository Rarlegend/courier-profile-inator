...
async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const {
      status,
      data
    } = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(`https://api.courier.com/debug`, {}, {
      headers: {
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8277);
      ...
      processEnv([])
        ...
        const apiHandler = (0,next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__/* .getApiHandler */ .Y)({
          pageModule: __webpack_require__(2484),
          rewrites: combinedRewrites,
          i18n: undefined,
          page: "/api/courier/verify",
          basePath: "",
          pageIsDynamic: false,
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [748,669,947,774,428], function() { return __webpack_require__(1829); })
